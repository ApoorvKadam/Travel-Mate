...
public class MyTripInfoActivity_ViewBinding implements Unbinder {
  ...
  public MyTripInfoActivity_ViewBinding(final MyTripInfoActivity target, View source) {
    ...
    View view;
    target.cityImageView = Utils.findRequiredViewAsType(source, R.id.city_image, "field 'cityImageView'", ImageView.class);
    ...
    target.addNewFriend = Utils.castView(view, R.id.add_new_friend, "field 'addNewFriend'", FlatButton.class);
    view2131296307 = view;
    ...
    view2131296440 = view;
    view2131296440TextWatcher = new TextWatcher() {
      @Override
    ...
    ((TextView) view).addTextChangedListener(view2131296440TextWatcher);
    ...
    target.details = Utils.findRequiredViewAsType(source, R.id.know_more, "field 'details'", Button.class);
  ...
  public void unbind() {
    ...
    view2131296307 = null;
    ((TextView) view2131296440).removeTextChangedListener(view2131296440TextWatcher);
    view2131296440TextWatcher = null;
    view2131296440 = null;
  }
}
