...
public class TripsListAdapter$ViewHolder_ViewBinding implements Unbinder {
  private TripsListAdapter.ViewHolder target;

  @UiThread
  public TripsListAdapter$ViewHolder_ViewBinding(TripsListAdapter.ViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TripsListAdapter.ViewHolder target = this.target;
